...
# <p style="text-align: center;"> BTES : BLOCKCHAIN TECHNOLOGY EDUCATIONAL SOFTWARE  </p>
...
<sub> <i> Important Note: Keep in mind that if you not logged in, saved datas not be seen at listed table or user can not be able to save their simulation activity. </i> <sub>
...
##### 3.3 Play & Pause Activity

* You can click "play" button to resume simulation. 
...
<span style="color:red"> <sub> <i>Note:  You should stop the simulation to save. </i> </sub> </span> 
