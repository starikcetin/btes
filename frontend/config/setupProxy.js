...
module.exports = (app) => {
  ...
  const restApiProxyAddress = process.env.REACT_APP_REST_PROXY || "http://localhost:3001";
  const socketApiProxyAddress = process.env.REACT_APP_SOCKET_PROXY || "http://localhost:3002";
